...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Delete Showtime'), ['action' => 'delete', $showtime->id], ['confirm' => __('Are you sure you want to delete showtime : # {0}?', $showtime->id)]) ?> </li>
        <li><?= $this->Html->link(__('New Showtimes'), ['action' => 'add']) ?></li>
